...
if (document.cookie) {
  ...
  document.querySelector(".user-name").innerHTML = getCookie("name");
}


function Delete(option){
console.log("click")
  const btns = document.querySelectorAll(`.btn-danger.${option}`)
  console.log(option)
btns.forEach(btn=>{
...
document.querySelector(".code-value").value = makeid()
})
